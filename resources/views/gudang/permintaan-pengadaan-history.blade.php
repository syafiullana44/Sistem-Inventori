...
@section('page-title', '📋 Laporan Permintaan Pengadaan')
...
<div class="card-custom mb-4">
    <form method="GET" class="row g-2 align-items-end">
        ...
        <div class="col-md-3">
            <a href="{{ route('gudang.permintaan-pengadaan-history.index') }}" class="btn btn-sm btn-secondary w-100">Reset</a>
        </div>
    </form>
</div>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('gudang.permintaan-pengadaan-history.export-pdf', request()->query()) }}" class="btn btn-sm btn-danger">
    ...
    @empty
    <div class="text-center text-muted py-4">Belum ada permintaan pengadaan</div>
    @endforelse
